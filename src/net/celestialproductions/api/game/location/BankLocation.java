...
public enum BankLocation implements Locatable {
    ...
    BURTHORPE("Burthorpe",                               Type.FULL,    new Coordinate(2888, 3535, 0), new Coordinate(-1, -1)),
    ...
    FALADOR_WEST("Falador West",                         Type.FULL,    new Coordinate(2945, 3369, 0), new Coordinate(-1, -1)),
    ...
    LIVING_ROCK_CAVERNS("Living Rock Caverns",           Type.DEPOSIT, new Coordinate(3652, 5114, 0), new Coordinate(-1, -1)),
    LUMBRIDGE_CASTLE("Lumbridge Castle",                 Type.FULL,    new Coordinate(3208, 3219, 2), new Coordinate(3208, 3219, 2)),
    LUMBRIDGE_COMBAT_ACADEMY("Lumbridge Combat Academy", Type.FULL,    new Coordinate(3215, 3257, 0), new Coordinate(-1, -1)),
    PISCATORIS("Piscatoris",                             Type.FULL,    new Coordinate(2330, 3690, 0), new Coordinate(2330, 3690, 0)),
    PORT_PHASMATYS("Port Phasmatys",                     Type.FULL,    new Coordinate(-1, -1),        new Coordinate(3690, 3466, 0)),
    ...
    VARROCK_EAST("Varrock East",                         Type.FULL,    new Coordinate(-1, -1),        new Coordinate(3253, 3420, 0)),
    VARROCK_WEST("Varrock West",                         Type.FULL,    new Coordinate(3190, 3435, 0), new Coordinate(-1, -1));
